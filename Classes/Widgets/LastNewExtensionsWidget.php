 ...
 */
class LastNewExtensionsWidget extends AbstractExtensionsWidget
{
    protected $apiEndpoint = 'https://api.t3extensions.org/s3/last10new.json';
    protected $title = AbstractExtensionsWidget::LANGUAGE_FILE . ':lastNewExtensionsWidget.title';
    protected $description = AbstractExtensionsWidget::LANGUAGE_FILE . ':lastNewExtensionsWidget.description';
